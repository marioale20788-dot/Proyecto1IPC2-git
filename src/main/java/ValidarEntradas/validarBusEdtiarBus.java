 ...
 * @author mario
 */
@WebServlet(name = "validarBusEdtiarBus", urlPatterns = {"/ValidarEntradas/validarBusEditarBus"})
public class validarBusEdtiarBus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sucursal = busBaseDeDatos.buscarSucursalAsociada(placaBus);
        ArrayList<Bus> bus = busBaseDeDatos.BuscarBuses(sucursal, placaBus);
